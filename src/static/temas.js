document.addEventListener("DOMContentLoaded", () => {
    ...
    const $themeSwitchersTab = document.getElementById("js-themes");
    ...
    document.addEventListener("click", (event) => {
        if (!$themeSwitchersTab.contains(event.target)) {
            $themeSwitchersTab.classList.remove('is-active');
        }
    });

    $themeCycle.addEventListener("click", (event) => {
        $themeSwitchersTab.classList.toggle('is-active');
